...
void write_eigenmodes_test_results()
{
...

    {
        ...
        double rmse;
        rmse =
            solve_eigenvalue_problem(mesh, evalues, Diamond, Quadratic_Areas_,
    ...
    {
        std::string meshname =
            "../data/volume_meshes/unit_balls/Pyramid_sphere.ovm";
        mesh.read(meshname);
        double rmse;
        filename = "Pyramids";
        rmse =
    ...
    {
        std::string meshname =
            "../data/volume_meshes/unit_balls/Truncated_sphere.ovm";
        mesh.read(meshname);
        double rmse;
        filename = "Truncated";
        rmse =
                ...
                std::ofstream& error_file, int function)
{
    if (function == Franke3d)
    {
        ...
        {
            error_file << solve_franke_poisson(
                mesh, PolySimpleLaplace, Quadratic_Areas_, Quadratic_Volume_);
        }
