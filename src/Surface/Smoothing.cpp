...
void Smoothing::implicit_smoothing(Scalar timestep, unsigned int laplace, unsigned int min_point, bool rescale)
{
    ...
    if(laplace == 2){
    if (!mesh_.has_face_property("f:point") || !mesh_.has_face_property("f:weights")) {
