...
static const char* basis_vshader =
...
static const char* basis_fshader =
#ifndef __EMSCRIPTEN__
    "#version 330\n"
#else
    "#version 300 es\n"
...
static const char* basis_vdiffshader =
#ifndef __EMSCRIPTEN__
    "#version 330"
#else
    "#version 300 es"
...
void main()
{
    ...
    v2f_tex      = v_tex;
    vec4 pos     = show_texture_layout ? vec4(v_tex, 0.0, 1.0) : v_position;
    pos.z -= scale *( (v_tex.x+v_tex.y) -pos.x) ;
    v2f_view     = -(modelview_matrix * pos).xyz;
    v2f_color    = v_color;
    gl_PointSize = point_size;
    gl_Position  = modelview_projection_matrix * pos;
...
static const char* basis_fdiffshader =
#ifndef __EMSCRIPTEN__
    "#version 330\n"
#else
    "#version 300 es\n"
